...
```
This graph shows the distributions of Father's Education (0 beign the lowest) and the Mother's Smoking habits. This graph, similar to the one beofre, also shows that Father's that have an education of 2, which represents those who have graduated from high school (as their highest level of schooling), are the most likely out of all of the education groups to have a wife that smokes. This data may or may not be correlated to the Father's Smoking habits as well, but this data set did not report the Father's smoking habits.

![__Smoking and Number of Cigaretts Smoked Per Day_](pre question/Pre Plot 5.png)
```
...
```
This grpah shows the relation between number of cigaretts smoked per day to general smoking habits. The differences between smokers and non-smokers should be very evident as if one does not smoke, the number of cigeretts one smokes per day should be zero.
