...
We believe that these two plots provide the best evidence for the Surgeon General's first assertion. I
n the first plot, one can clearly see that out of all the premature babies, the majority come from women that said 
...
![Amanda's Plot](AmandaParity.png) 
...
who have had x amount of births in the past. The bars are then color-coded by whether or not that womean has had a premature birth. 
...
__Chris__:
__Amanda__:  used the bar plot geom for my plot to analyze any relationships between parity and the birth of premature babies. 
...
__James__:
__Anna__: I used a bar graph with color being another variable. I also used labs to name specific parts of my plot. I used scale_fill_discrete to also rename parts of my legend. 
                 I also used a position funciton insdie of my geom_bar function.
__Amanda__:
__James__: I used a violin plot. I added labels, changed the title of my legend, and changed the theme of the plot. I also used scale_fill_brewer to change the color of my plot. 
