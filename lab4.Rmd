...
I used the bar plot geom for my plot to analyze any relationships between parity and the birth of premature babies. 
...
__Amanda__:
__James__:
__Anna__: I used a bar graph with color being another variable. I also used labs to name specific parts of my plot. I used scale_fill_discrete to also rename parts of my legend. I also used a position funciton insdie of my geom_bar function.
